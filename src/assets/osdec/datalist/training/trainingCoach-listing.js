    ...
    var t = function() {
        var t = $(".m_datatable").mDatatable({
                data: {
                    ...
                    source: {
                        read: {
                            url: "http://localhost:8080/api/training/coach/list"
                        }
                    },
                    pageSize: 10,
                    saveState: {
                ...
                columns: [{
                    ...
                    template: function(t){
                        ...
                        return '<a href="/training/peserta/' +t.training.id+ '" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill btn-outline-success" title="Senarai Peserta">\t\t\t\t\t\t\t<i class="la la-edit"></i>\t\t\t\t\t\t</a>\t\t\t\t\t\t'
                    }
                }]
            }),    
