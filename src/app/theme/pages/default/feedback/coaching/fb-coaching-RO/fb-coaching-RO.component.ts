...
@Component({
    ...
    templateUrl: "./fb-coaching-RO.component.html",
    encapsulation: ViewEncapsulation.None,
    providers: [ FeedbackService]
})
export class FBCoachingROComponent implements OnInit, AfterViewInit, OnDestroy  {
  ...
  objective: string;
    ...
    ngAfterViewInit() {
      ...
      if(this.userid && this.instanceid && this.id){
