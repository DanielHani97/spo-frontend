...
@Component({
    ...
    templateUrl: "./coaching-ls-supervisor.component.html",
    encapsulation: ViewEncapsulation.None,
    providers: [CoachingService]
})
export class CoachingLsSupervisorComponent implements OnInit, AfterViewInit {
            ...
            data: {
                ...
                columns: [{
                    ...
                    template: function(t) {
                        ...
                        var toreturn = '<a href="/coaching/view/'+ t.id +'" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill btn-outline-success" title="Lihat Maklumat">\t\t\t\t\t\t\t<i class="la la-ellipsis-h"></i>\t\t\t\t\t\t</a>\t\t\t\t\t\t';
                        if(t.status==4){
                            toreturn = toreturn + '<a href="/coaching/actApprove/'+ t.id +'" class="m-portlet__nav-link btn m-btn m-btn--hover-primary m-btn--icon m-btn--icon-only m-btn--pill btn-outline-primary" title="Kelulusan Aktiviti">\t\t\t\t\t\t\t<i class="la la-check"></i>\t\t\t\t\t\t</a>\t\t\t\t\t\t';
                        }
                        return toreturn;
                    }
