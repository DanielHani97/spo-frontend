...
@Component({
    ...
    templateUrl: "./trainingList-admin.component.html",
    encapsulation: ViewEncapsulation.None,
    providers: [TrainingService]
})
export class TrainingListAdminComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    backPage(){
      this.router.navigate(['/training/admin/']);
    }
        ...
        data: {
                ...
                columns: [{
                    ...
                    template: function(t) {
                      ...
                      var htmlNew = '<a href="/training/approval/'+t.id+'" class="m-portlet__nav-link btn m-btn m-btn--hover-primary m-btn--icon m-btn--icon-only m-btn--pill btn-outline-primary" title="Kelulusan">\t\t\t\t\t\t\t<i class="la la-pencil"></i>\t\t\t\t\t\t</a>';
                      var htmlRO = '<a href="/training/approval/view/'+t.id+'" class="m-portlet__nav-link btn m-btn m-btn--hover-primary m-btn--icon m-btn--icon-only m-btn--pill btn-outline-primary" title="Lihat Maklumat">\t\t\t\t\t\t\t<i class="la la-ellipsis-h"></i>\t\t\t\t\t\t</a>';
